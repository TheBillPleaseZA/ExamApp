...
public class YahooItem implements Comparable<YahooItem>{
	...
	public YahooItem copy(){
		YahooItem copy = new YahooItem();
		copy.title = title;
		copy.link = link;
	...
	public int compareTo(YahooItem another) {
